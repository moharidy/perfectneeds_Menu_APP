...
public class MakiActivity_Arabic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maki__arabic);
        ...
        ura_maki.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MakiActivity_Arabic.this, "قائمة أورا ماكي", Toast.LENGTH_SHORT).show();
                ...
                mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    ...
                    public void onCompletion(MediaPlayer mp) {
                        Intent intent = new Intent(MakiActivity_Arabic.this, MakiSubActivity_Arabic.class);
