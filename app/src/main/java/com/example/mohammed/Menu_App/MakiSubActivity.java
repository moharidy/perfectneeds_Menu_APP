...
public class MakiSubActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuItems.add( new Menu_Item("Ura Grilled Salmon", "Grilled Salmon, Cucomber, topped with Seaseme Seeds & Tiryaki",R.drawable.ura_grilled_salmon,R.raw.ura_grilled_salmon) );
        menuItems.add( new Menu_Item("Ura Grilled Salmon", "Grilled Salmon, Cucomber, topped with Seaseme Seeds & Tiryaki",R.drawable.ura_grilled_salmon,R.raw.ura_grilled_salmon) );
        menuItems.add( new Menu_Item("Ura Grilled Salmon", "Grilled Salmon, Cucomber, topped with Seaseme Seeds & Tiryaki",R.drawable.ura_grilled_salmon,R.raw.ura_grilled_salmon) );
        menuItems.add( new Menu_Item("Ura Grilled Salmon", "Grilled Salmon, Cucomber, topped with Seaseme Seeds & Tiryaki",R.drawable.ura_grilled_salmon,R.raw.ura_grilled_salmon) );
        menuItems.add( new Menu_Item("Ura Grilled Salmon", "Grilled Salmon, Cucomber, topped with Seaseme Seeds & Tiryaki",R.drawable.ura_grilled_salmon,R.raw.ura_grilled_salmon) );
